...
| :--- | :--- | :--- |
| **[gabaritei-ia](https://github.com/PedroT4skr/gabaritei-ia)** | Correção automática de gabaritos via câmera utilizando inteligência e visão computacional (OMR). | `TypeScript` `Computer Vision` |
| **[react-media-streaming-app](https://github.com/PedroT4skr/react-media-streaming-app)** | Aplicação de streaming de mídia moderna, responsiva e de alta performance. | `TypeScript` `React` |
